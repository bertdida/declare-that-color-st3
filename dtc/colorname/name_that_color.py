class NameThatColor:
    ...
    def color_name(cls, hex_code):
        ...
        for i, current_color in enumerate(cls.color_names):
            ...
            ndf1 = (
                pow(r - current_color[2], 2) +
                pow(g - current_color[3], 2) +
                pow(b - current_color[4], 2)
            )

            ndf2 = (
                pow(h - current_color[5], 2) +
                pow(s - current_color[6], 2) +
                pow(l - current_color[7], 2)
            )
